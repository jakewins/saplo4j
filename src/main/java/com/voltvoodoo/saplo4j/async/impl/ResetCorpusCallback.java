...
public class ResetCorpusCallback extends AbstractInternalCallback {
	...
	public ResetCorpusCallback() {
	}

	public ResetCorpusCallback(SaploCallback<Boolean> userCallback) {
